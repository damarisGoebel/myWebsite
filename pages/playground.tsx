...
export async function getStaticProps() {
  const res = await fetch(
    'https://api.rss2json.com/v1/api.json?rss_url=https://medium.com/feed/@damaris-goebel',
  )
...
const PlaygroundPage = ({ data }) => {
  ...
  return (
    <Layout title="Playground - Blog">
      ...
      <p>
        I will post my learnings, my worth-to-write-down and useful-to-remember
        knowledge and it will be my personal library to look up things.{' '}
      </p>
              ...
              <ul className={styles.post}>
                <li className={styles.postItem}>
                  <div className={styles.content}>
                    <h1>{post.title}</h1>
                    {!post.thumbnail.includes('https://medium.com/_/stat') && (
